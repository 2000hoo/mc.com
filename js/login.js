 ...
 // 1. 获取元素
 const nameInp = document.querySelector('.Login input[name=username]')
 const pwdInp = document.querySelector('.Login input[name=password]')
 ...
 form.addEventListener('submit', e => {
    ...
    ajax({
        ...
        success(res) {
            ...
            if (code === 1) {
                window.location.href = 'index.html?usersId='+ data[0].id
            } else if (code === 2) {
